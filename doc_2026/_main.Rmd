...
#MAKE WCGBTS_SPECIES FUNCTION

nwfscSurvey::get_species_info(species = nwfscSurvey::GetSppDefault.fn())
...
wcgbt_bio <- bio
#why does this have yellowtail, yellowtail north, and yellowtail south?
age_species <- bio |>
