...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{../plots/state_comparisons/arrowtooth_flounder_state_compositions.png}}
...
\caption{Estimated relative index of abundance from the NWFSC West Coast
...
Groundfish Bottom Trawl survey. Size of the circles within a year
...
\begin{longtable}[t]{>{\raggedleft\arraybackslash}p{2cm}>{\raggedleft\arraybackslash}p{3.5cm}>{\raggedleft\arraybackslash}p{2cm}>{\raggedleft\arraybackslash}p{2cm}>{\raggedleft\arraybackslash}p{2cm}}
\caption{\label{tab:unnamed-chunk-12}Total number of available lengths, read ages, and unread age structures by data source and
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{../plots/state_comparisons/aurora_rockfish_state_compositions.png}}
...
\begin{longtable}[t]{>{\raggedleft\arraybackslash}p{2cm}>{\raggedleft\arraybackslash}p{3.5cm}>{\raggedleft\arraybackslash}p{2cm}>{\raggedleft\arraybackslash}p{2cm}>{\raggedleft\arraybackslash}p{2cm}}
\caption{\label{tab:unnamed-chunk-21}Total number of available lengths, read ages, and unread age structures by data source and
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{../plots/state_comparisons/bank_rockfish_state_compositions.png}}
...
\caption{Estimated relative index of abundance from the NWFSC Hook and
Line survey.}
...
\caption{Length (cm) compostion data from the NWFSC Hook and Line
survey. Size of the circles within a year indicate higher (larger
...
\begin{longtable}[t]{>{\raggedleft\arraybackslash}p{2cm}>{\raggedleft\arraybackslash}p{3.5cm}>{\raggedleft\arraybackslash}p{2cm}>{\raggedleft\arraybackslash}p{2cm}>{\raggedleft\arraybackslash}p{2cm}}
\caption{\label{tab:unnamed-chunk-30}Total number of available lengths, read ages, and unread age structures by data source and
state for big skate.}\\
\toprule
State & Source & Lengths & Ages & Age Structures\\
\midrule
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{../plots/state_comparisons/big_skate_state_compositions.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{../plots/state_comparisons/blackgill_rockfish_state_compositions.png}}
...
\begin{longtable}[t]{>{\raggedleft\arraybackslash}p{2cm}>{\raggedleft\arraybackslash}p{3.5cm}>{\raggedleft\arraybackslash}p{2cm}>{\raggedleft\arraybackslash}p{2cm}>{\raggedleft\arraybackslash}p{2cm}}
\caption{\label{tab:unnamed-chunk-49}Total number of available lengths, read ages, and unread age structures by data source and
state for bocaccio.}\\
\toprule
State & Source & Lengths & Ages & Age Structures\\
\midrule
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{../plots/state_comparisons/bocaccio_state_compositions.png}}
...
\begin{longtable}[t]{>{\raggedleft\arraybackslash}p{2cm}>{\raggedleft\arraybackslash}p{3.5cm}>{\raggedleft\arraybackslash}p{2cm}>{\raggedleft\arraybackslash}p{2cm}>{\raggedleft\arraybackslash}p{2cm}}
\caption{\label{tab:unnamed-chunk-59}Total number of available lengths, read ages, and unread age structures by data source and
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{../plots/state_comparisons/california_scorpionfish_state_compositions.png}}
...
\begin{longtable}[t]{>{\raggedleft\arraybackslash}p{2cm}>{\raggedleft\arraybackslash}p{3.5cm}>{\raggedleft\arraybackslash}p{2cm}>{\raggedleft\arraybackslash}p{2cm}>{\raggedleft\arraybackslash}p{2cm}}
\caption{\label{tab:unnamed-chunk-68}Total number of available lengths, read ages, and unread age structures by data source and
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{../plots/state_comparisons/canary_rockfish_state_compositions.png}}
...
\begin{longtable}[t]{>{\raggedleft\arraybackslash}p{2cm}>{\raggedleft\arraybackslash}p{3.5cm}>{\raggedleft\arraybackslash}p{2cm}>{\raggedleft\arraybackslash}p{2cm}>{\raggedleft\arraybackslash}p{2cm}}
\caption{\label{tab:unnamed-chunk-77}Total number of available lengths, read ages, and unread age structures by data source and
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{../plots/state_comparisons/chilipepper_state_compositions.png}}
...
\begin{longtable}[t]{>{\raggedleft\arraybackslash}p{2cm}>{\raggedleft\arraybackslash}p{3.5cm}>{\raggedleft\arraybackslash}p{2cm}>{\raggedleft\arraybackslash}p{2cm}>{\raggedleft\arraybackslash}p{2cm}}
\caption{\label{tab:unnamed-chunk-87}Total number of available lengths, read ages, and unread age structures by data source and
state for cowcod.}\\
\toprule
State & Source & Lengths & Ages & Age Structures\\
\midrule
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{../plots/state_comparisons/cowcod_state_compositions.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{../plots/state_comparisons/darkblotched_rockfish_state_compositions.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{../plots/state_comparisons/dover_sole_state_compositions.png}}
...
\begin{longtable}[t]{>{\raggedleft\arraybackslash}p{2cm}>{\raggedleft\arraybackslash}p{3.5cm}>{\raggedleft\arraybackslash}p{2cm}>{\raggedleft\arraybackslash}p{2cm}>{\raggedleft\arraybackslash}p{2cm}}
\caption{\label{tab:unnamed-chunk-114}Total number of available lengths, read ages, and unread age structures by data source and
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{../plots/state_comparisons/english_sole_state_compositions.png}}
...
\begin{longtable}[t]{>{\raggedleft\arraybackslash}p{2cm}>{\raggedleft\arraybackslash}p{3.5cm}>{\raggedleft\arraybackslash}p{2cm}>{\raggedleft\arraybackslash}p{2cm}>{\raggedleft\arraybackslash}p{2cm}}
\caption{\label{tab:unnamed-chunk-123}Total number of available lengths, read ages, and unread age structures by data source and
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{../plots/state_comparisons/flathead_sole_state_compositions.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{../plots/state_comparisons/greenspotted_rockfish_state_compositions.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{../plots/state_comparisons/greenstriped_rockfish_state_compositions.png}}
...
\begin{longtable}[t]{>{\raggedleft\arraybackslash}p{2cm}>{\raggedleft\arraybackslash}p{3.5cm}>{\raggedleft\arraybackslash}p{2cm}>{\raggedleft\arraybackslash}p{2cm}>{\raggedleft\arraybackslash}p{2cm}}
\caption{\label{tab:unnamed-chunk-150}Total number of available lengths, read ages, and unread age structures by data source and
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{../plots/state_comparisons/kelp_greenling_state_compositions.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{../plots/state_comparisons/lingcod_north_state_compositions.png}}
...
\begin{longtable}[t]{>{\raggedleft\arraybackslash}p{2cm}>{\raggedleft\arraybackslash}p{3.5cm}>{\raggedleft\arraybackslash}p{2cm}>{\raggedleft\arraybackslash}p{2cm}>{\raggedleft\arraybackslash}p{2cm}}
\caption{\label{tab:unnamed-chunk-168}Total number of available lengths, read ages, and unread age structures by data source and
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{../plots/state_comparisons/lingcod_south_state_compositions.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{../plots/state_comparisons/longnose_skate_state_compositions.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{../plots/state_comparisons/longspine_thornyhead_state_compositions.png}}
...
\begin{longtable}[t]{>{\raggedleft\arraybackslash}p{2cm}>{\raggedleft\arraybackslash}p{3.5cm}>{\raggedleft\arraybackslash}p{2cm}>{\raggedleft\arraybackslash}p{2cm}>{\raggedleft\arraybackslash}p{2cm}}
\caption{\label{tab:unnamed-chunk-195}Total number of available lengths, read ages, and unread age structures by data source and
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{../plots/state_comparisons/pacific_cod_state_compositions.png}}
...
\begin{longtable}[t]{>{\raggedleft\arraybackslash}p{2cm}>{\raggedleft\arraybackslash}p{3.5cm}>{\raggedleft\arraybackslash}p{2cm}>{\raggedleft\arraybackslash}p{2cm}>{\raggedleft\arraybackslash}p{2cm}}
\caption{\label{tab:unnamed-chunk-204}Total number of available lengths, read ages, and unread age structures by data source and
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{../plots/state_comparisons/pacific_ocean_perch_state_compositions.png}}
...
\begin{longtable}[t]{>{\raggedleft\arraybackslash}p{2cm}>{\raggedleft\arraybackslash}p{3.5cm}>{\raggedleft\arraybackslash}p{2cm}>{\raggedleft\arraybackslash}p{2cm}>{\raggedleft\arraybackslash}p{2cm}}
\caption{\label{tab:unnamed-chunk-213}Total number of available lengths, read ages, and unread age structures by data source and
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{../plots/state_comparisons/pacific_sanddab_state_compositions.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{../plots/state_comparisons/pacific_spiny_dogfish_state_compositions.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{../plots/state_comparisons/petrale_sole_state_compositions.png}}
...
\begin{longtable}[t]{>{\raggedleft\arraybackslash}p{2cm}>{\raggedleft\arraybackslash}p{3.5cm}>{\raggedleft\arraybackslash}p{2cm}>{\raggedleft\arraybackslash}p{2cm}>{\raggedleft\arraybackslash}p{2cm}}
\caption{\label{tab:unnamed-chunk-240}Total number of available lengths, read ages, and unread age structures by data source and
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{../plots/state_comparisons/quillback_rockfish_state_compositions.png}}
...
\begin{longtable}[t]{>{\raggedleft\arraybackslash}p{2cm}>{\raggedleft\arraybackslash}p{3.5cm}>{\raggedleft\arraybackslash}p{2cm}>{\raggedleft\arraybackslash}p{2cm}>{\raggedleft\arraybackslash}p{2cm}}
\caption{\label{tab:unnamed-chunk-249}Total number of available lengths, read ages, and unread age structures by data source and
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{../plots/state_comparisons/redbanded_rockfish_state_compositions.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{../plots/state_comparisons/redstripe_rockfish_state_compositions.png}}
...
\begin{longtable}[t]{>{\raggedleft\arraybackslash}p{2cm}>{\raggedleft\arraybackslash}p{3.5cm}>{\raggedleft\arraybackslash}p{2cm}>{\raggedleft\arraybackslash}p{2cm}>{\raggedleft\arraybackslash}p{2cm}}
\caption{\label{tab:unnamed-chunk-267}Total number of available lengths, read ages, and unread age structures by data source and
state for rex sole.}\\
\toprule
State & Source & Lengths & Ages & Age Structures\\
\midrule
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{../plots/state_comparisons/rex_sole_state_compositions.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{../plots/state_comparisons/rosethorn_rockfish_state_compositions.png}}
...
\begin{longtable}[t]{>{\raggedleft\arraybackslash}p{2cm}>{\raggedleft\arraybackslash}p{3.5cm}>{\raggedleft\arraybackslash}p{2cm}>{\raggedleft\arraybackslash}p{2cm}>{\raggedleft\arraybackslash}p{2cm}}
\caption{\label{tab:unnamed-chunk-285}Total number of available lengths, read ages, and unread age structures by data source and
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{../plots/state_comparisons/rougheye_and_blackspotted_rockfish_state_compositions.png}}
...
\begin{longtable}[t]{>{\raggedleft\arraybackslash}p{2cm}>{\raggedleft\arraybackslash}p{3.5cm}>{\raggedleft\arraybackslash}p{2cm}>{\raggedleft\arraybackslash}p{2cm}>{\raggedleft\arraybackslash}p{2cm}}
\caption{\label{tab:unnamed-chunk-294}Total number of available lengths, read ages, and unread age structures by data source and
state for sablefish.}\\
\toprule
State & Source & Lengths & Ages & Age Structures\\
\midrule
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{../plots/state_comparisons/sablefish_state_compositions.png}}
...
\begin{longtable}[t]{>{\raggedleft\arraybackslash}p{2cm}>{\raggedleft\arraybackslash}p{3.5cm}>{\raggedleft\arraybackslash}p{2cm}>{\raggedleft\arraybackslash}p{2cm}>{\raggedleft\arraybackslash}p{2cm}}
\caption{\label{tab:unnamed-chunk-303}Total number of available lengths, read ages, and unread age structures by data source and
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{../plots/state_comparisons/sharpchin_rockfish_state_compositions.png}}
...
\begin{longtable}[t]{>{\raggedleft\arraybackslash}p{2cm}>{\raggedleft\arraybackslash}p{3.5cm}>{\raggedleft\arraybackslash}p{2cm}>{\raggedleft\arraybackslash}p{2cm}>{\raggedleft\arraybackslash}p{2cm}}
\caption{\label{tab:unnamed-chunk-313}Total number of available lengths, read ages, and unread age structures by data source and
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{../plots/state_comparisons/shortspine_thornyhead_state_compositions.png}}
...
\begin{longtable}[t]{>{\raggedleft\arraybackslash}p{2cm}>{\raggedleft\arraybackslash}p{3.5cm}>{\raggedleft\arraybackslash}p{2cm}>{\raggedleft\arraybackslash}p{2cm}>{\raggedleft\arraybackslash}p{2cm}}
\caption{\label{tab:unnamed-chunk-322}Total number of available lengths, read ages, and unread age structures by data source and
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{../plots/state_comparisons/silvergray_rockfish_state_compositions.png}}
...
\begin{longtable}[t]{>{\raggedleft\arraybackslash}p{2cm}>{\raggedleft\arraybackslash}p{3.5cm}>{\raggedleft\arraybackslash}p{2cm}>{\raggedleft\arraybackslash}p{2cm}>{\raggedleft\arraybackslash}p{2cm}}
\caption{\label{tab:unnamed-chunk-331}Total number of available lengths, read ages, and unread age structures by data source and
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{../plots/state_comparisons/splitnose_rockfish_state_compositions.png}}
...
\begin{longtable}[t]{>{\raggedleft\arraybackslash}p{2cm}>{\raggedleft\arraybackslash}p{3.5cm}>{\raggedleft\arraybackslash}p{2cm}>{\raggedleft\arraybackslash}p{2cm}>{\raggedleft\arraybackslash}p{2cm}}
\caption{\label{tab:unnamed-chunk-340}Total number of available lengths, read ages, and unread age structures by data source and
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{../plots/state_comparisons/squarespot_rockfish_state_compositions.png}}
...
\begin{longtable}[t]{>{\raggedleft\arraybackslash}p{2cm}>{\raggedleft\arraybackslash}p{3.5cm}>{\raggedleft\arraybackslash}p{2cm}>{\raggedleft\arraybackslash}p{2cm}>{\raggedleft\arraybackslash}p{2cm}}
\caption{\label{tab:unnamed-chunk-349}Total number of available lengths, read ages, and unread age structures by data source and
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{../plots/state_comparisons/starry_rockfish_state_compositions.png}}
...
\begin{longtable}[t]{>{\raggedleft\arraybackslash}p{2cm}>{\raggedleft\arraybackslash}p{3.5cm}>{\raggedleft\arraybackslash}p{2cm}>{\raggedleft\arraybackslash}p{2cm}>{\raggedleft\arraybackslash}p{2cm}}
\caption{\label{tab:unnamed-chunk-358}Total number of available lengths, read ages, and unread age structures by data source and
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{../plots/state_comparisons/stripetail_rockfish_state_compositions.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{../plots/state_comparisons/vermilion_and_sunset_rockfish_state_compositions.png}}
...
\begin{longtable}[t]{>{\raggedleft\arraybackslash}p{2cm}>{\raggedleft\arraybackslash}p{3.5cm}>{\raggedleft\arraybackslash}p{2cm}>{\raggedleft\arraybackslash}p{2cm}>{\raggedleft\arraybackslash}p{2cm}}
\caption{\label{tab:unnamed-chunk-376}Total number of available lengths, read ages, and unread age structures by data source and
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{../plots/state_comparisons/widow_rockfish_state_compositions.png}}
...
\begin{longtable}[t]{>{\raggedleft\arraybackslash}p{2cm}>{\raggedleft\arraybackslash}p{3.5cm}>{\raggedleft\arraybackslash}p{2cm}>{\raggedleft\arraybackslash}p{2cm}>{\raggedleft\arraybackslash}p{2cm}}
\caption{\label{tab:unnamed-chunk-385}Total number of available lengths, read ages, and unread age structures by data source and
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{../plots/state_comparisons/yelloweye_rockfish_state_compositions.png}}
...
\begin{longtable}[t]{>{\raggedleft\arraybackslash}p{2cm}>{\raggedleft\arraybackslash}p{3.5cm}>{\raggedleft\arraybackslash}p{2cm}>{\raggedleft\arraybackslash}p{2cm}>{\raggedleft\arraybackslash}p{2cm}}
\caption{\label{tab:unnamed-chunk-394}Total number of available lengths, read ages, and unread age structures by data source and
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{../plots/state_comparisons/yellowmouth_rockfish_state_compositions.png}}
...
\begin{longtable}[t]{>{\raggedleft\arraybackslash}p{2cm}>{\raggedleft\arraybackslash}p{3.5cm}>{\raggedleft\arraybackslash}p{2cm}>{\raggedleft\arraybackslash}p{2cm}>{\raggedleft\arraybackslash}p{2cm}}
\caption{\label{tab:unnamed-chunk-403}Total number of available lengths, read ages, and unread age structures by data source and
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{../plots/state_comparisons/yellowtail_rockfish_north_state_compositions.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{../plots/state_comparisons/yellowtail_rockfish_south_state_compositions.png}}
